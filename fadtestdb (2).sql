...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 08 mai 2024 à 17:55
...
(5, '160.00', 'electronic', '199.00', '8.0', '10121011', '13', 'F', 'stock');
...
INSERT INTO `user` (`id_User`, `login_User`, `password_User`, `nom_User`, `prenom_User`, `tel_User`, `note_User`, `type_User`) VALUES
(1, 'admin1', '123', 'hbti', 'pls', '06321132', 'qmfjdqmlkfjdqsjfmqlskf', 'Super Admin'),
(2, 'admin2', '000', 'lsqh', 'khalid', '0632113212', 'sgjsdmlkgjdfg', 'Admin'),
(4, 'admin3', '444', 'hbti', 'pls', '06321132', 'qmfjdqmlkfjdqsjfmqlskf', 'Super Admin'),
(5, 'admin5', '444', 'hbti', 'pls', '06321132', 'qmfjdqmlkfjdqsjfmqlskf', 'Utilisateur');
...
--
ALTER TABLE `produit`
  MODIFY `id_Produit` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
