...
router.get('/user', verifyToken, obtenirDonnéesUser)
router.get('/user/:id', verifyToken, obtenirUserID)
router.post('/user', verifyToken, ajouterUser)
router.put('/user/:id', verifyToken, modifierUser)
router.delete('/user/:id', verifyToken, supprimerUser)
