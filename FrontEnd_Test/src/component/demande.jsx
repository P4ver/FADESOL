          ...
          <tbody>
            {products.map((product, index) => (
              <tr key={index}>
                ...
                <td>{product.quat2}</td>
                <td>{product.qt2}</td>
                <td>{product.projet}</td>
                <td>{product.nonProjet}</td>
