...
//       // Find the highest existing code_Achat and increment it
//       const maxCodeAchat = Math.max(...demandeData.map(d => parseInt(d.code_Achat || '0', 10)), 0);
//       setCode_Achat((maxCodeAchat + 1).toString().padStart(5, '0')); // Increment and pad with zeros if necessary
//     }
//   }, [demandeData]);
...
//       }
//       setLines([{ demandeCode: '', projetCode: '', quantite: '' }]);
//       // Automatically generate a new code_Achat for the next submission
//       const newCodeAchat = (parseInt(code_Achat, 10) + 1).toString().padStart(5, '0');
//       setCode_Achat(newCodeAchat);
//     } catch (error) {
//       console.error('Error submitting data:', error.message);
//     }
//   };
...
//           value={code_Achat}
//           placeholder='Code Achat'
//           onChange={(e) => setCode_Achat(e.target.value)} // Optional: allow manual change
//           className="w-full px-2 py-1 border rounded-md"
