...
//   //       }
//   //       console.log("updatedItem id_Article",updatedItem.id_Article)
//   //       const product = productData.find(p =>{ 
//   //         console.log("inside product: ",updatedItem.designation)
//   //         p.Description_Article == updatedItem.designation
//   //       });
//   //       console.log("===>handel==>productdata:",product)
//   //       // if (!product) {
//   //       //   throw new Error(`Product with designation ${updatedItem.designation} not found`);
//   //       // }
//   //       const newQteMagasin = updatedItem.qte_Magasin + parseInt(qteRecu[id])
//   //       // const newQteMagasin = product.qte_Magasin + parseInt(qteRecu[id]);
//   //       // console.log("dfdsf",newQteMagasin)
//   //       await dispatch(updateQteMagasin({
//   //         productId: updatedItem.id_Article,
