    ...
    <tbody>
      {venteData.filter(a => a.code_Sortie === selectedAchat?.code_Sortie).map((item, idx) => (
        <tr key={idx} className='border'>
          ...
          <td className=" border border-black text-[9px] text-center  py-1 w-2/4">{item.designation_Produit}</td>
          <td className=" border border-black text-[9px] text-center   py-1 w-1/4">{item.Partenaire}</td>
          <td className=" border border-black text-[9px] text-center py-1 w-1/4">{item.qte_Produit}</td>
