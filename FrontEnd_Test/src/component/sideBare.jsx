...
//       <nav
//         aria-label="Sidebar Navigation"
//         className="peer-checked:w-44 left-0 z-10 flex h-screen w-0 flex-col overflow-hidden bg-gray-800 text-white transition-all duration-300 md:h-screen md:w-44 lg:w-44"
//       >
//         <div className="bg-gray-900 mt-5 py-4 px-10 md:mt-10">
//           <div className="w-36">
//             {/* Logo goes here */}
//           </div>
//         </div>
...
//           </div>
//         </div>
//         <div className="flex items-center px-6 py-3 space-x-3 bg-gray-700 rounded-lg mt-4">
//           <img
//             src="path/to/avatar/image"  // Replace with the path to the avatar image
//             alt="User Avatar"
