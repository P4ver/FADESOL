    ...
    try {
      ...
      if (updatedUser) {
        ...
        const result = await Swal.fire({
          ...
          confirmButtonText: status === 'Active' ? "Yes, make it inactive!" : "Yes, activate it!",
        ...
        if (result.isConfirmed) {
          ...
          toast.info('Action canceled by Super Admin');
        }
      }
    } catch (error) {
      console.error('Error toggling user status:', error);
...
//   //   return canvas.toDataURL('image/png');
//   // };
//   const DeactivateDialog = ({ isOpen, onClose }) => (
...
//   return (
//     <>
//     <DeactivateDialog isOpen={openDialog} onClose={() => setOpenDialog(false)} />
//       <div className="py-3 px-4 flex justify-between items-center">
//         <div className="flex">
//               <div className="relative max-w-md">
//             <label className="sr-only">Search</label>
