...
//     try {
//       const response = await axios.put(`http://localhost:3000/produits/${productId}/qte, { qte_Magasin }, {
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         withCredentials: true,
...
export const updateQteMagasin = createAsyncThunk(
  ...
  async ({ productId, qte_Magasin }, thunkAPI) => {
    try {
      const response = await axios.put(`http://localhost:3000/produits/qte/${productId}`, { qte_Magasin }, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
