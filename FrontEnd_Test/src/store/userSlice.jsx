...
export const fetchUserData = createAsyncThunk(
    ...
    async (_, thunkAPI) => {
      try {
        const response = await axios.get('https://fadesol.onrender.com/user', {
  ...
  export const postUserData = createAsyncThunk(
    ...
    async (postData, thunkAPI) => {
      try {
        const response = await axios.post('https://fadesol.onrender.com/user', postData, {
          headers: {
...
export const updateUserData = createAsyncThunk(
  ...
  async ({ id_User, updateUserData }, thunkAPI) => {
    try {
      const response = await axios.put(`https://fadesol.onrender.com/user/${id_User}`, updateUserData, {
        headers: {
          'Content-Type': 'application/json',
        },
        withCredentials: true,
...
export const deleteUserData = createAsyncThunk(
  ...
  async (id_User, thunkAPI) => {
    try {
      const response = await axios.delete(`https://fadesol.onrender.com/user/${id_User}`,{
          withCredentials: true,
      });
      if (response.status !== 200) {
